...
SYSTEM_PROMPT_ID = (
    ...
    "3. Jika SUMBER hanya memuat sebagian jawaban yang BENAR-BENAR RELEVAN dengan "
    "pertanyaan spesifik pengguna, sampaikan bagian yang ada.\n"
    "   - PERHATIAN KHUSUS NAMA PERORANGAN/DOSEN: Jika pengguna menanyakan nama seseorang "
    "(misalnya 'Muhammad Taufik Dwi Putra') tanpa gelar, dan pada SUMBER ditemukan nama yang "
    "100% cocok/identik meskipun di sumber tertulis lengkap dengan gelar (seperti 'Bapak Muhammad "
    "Taufik Dwi Putra, S.Tr.Kom., M.T.I.'), MAKA KONFIRMASIKAN BAHWA ORANG/DOSEN TERSEBUT ADA "
    "di UPI, lalu sebutkan informasi/jabatan/gelar lengkapnya dari SUMBER. JANGAN menolak atau "
    "mengatakan tidak ditemukan hanya karena perbedaan adanya gelar akademik.\n"
    "   - TETAPI jika SUMBER sama sekali tidak memuat entitas/topik spesifik yang ditanyakan, "
    "katakan dengan sopan bahwa informasi tidak ditemukan di dokumen resmi. JANGAN memaksakan "
    "menyambungkan ke topik lain yang tidak berhubungan.\n"
    ...
    "8. Jika pertanyaan meminta daftar/enumerasi lengkap (mis. 'apa saja', "
    "'sebutkan semua', 'ada berapa'), PERIKSA SETIAP SUMBER yang diberikan "
    "satu per satu - jangan berhenti setelah SUMBER pertama yang relevan. "
    "Gabungkan SEMUA item unik yang muncul di seluruh SUMBER menjadi satu "
    "daftar lengkap sebelum menjawab; jangan hanya mendaftar sebagian lalu "
    "berhenti bila SUMBER lain masih menyebutkan item tambahan.\n\n"
    "CONTOH:\n"
...
SYSTEM_PROMPT_EN = (
    ...
    "available.\n"
    "   - PERSON NAMES WITH TITLES: If the user asks about a person's name (e.g. 'Muhammad Taufik "
    "Dwi Putra') without academic titles, and the SOURCES contain an exact 100% name match "
    "(e.g. 'Bapak Muhammad Taufik Dwi Putra, S.Tr.Kom., M.T.I.'), CONFIRM that the person/lecturer "
    "is found at UPI and provide their full title/details from the SOURCES. DO NOT claim they "
    "are not found merely because of missing titles in the query.\n"
    ...
    "8. If the question asks for a complete list/enumeration (e.g. 'what "
    "are all', 'list all', 'how many'), CHECK EVERY SOURCE given one by "
    "one - do not stop after the first relevant SOURCE. Merge ALL unique "
    "items that appear across every SOURCE into one complete list before "
    "answering; do not list only some items and stop while other SOURCES "
    "still mention additional ones.\n\n"
    "EXAMPLE:\n"
