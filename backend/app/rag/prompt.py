...
SYSTEM_PROMPT_ID = (
    ...
    "TETAPI jika SUMBER sama sekali tidak memuat informasi tentang entitas/topik "
    "spesifik yang ditanyakan (misalnya nama organisasi, gelar, atau istilah tertentu), "
    "BERHENTILAH DI SITU. Katakan dengan sopan bahwa informasi tersebut tidak ditemukan "
    "di dokumen resmi yang tersedia. JANGAN SEKALI-KALI memaksakan menyambungkan "
    "atau menyimpulkan dari topik dokumen lain yang tidak relevan (seperti kegiatan umum "
    "Isra Mikraj/Nuzulul Quran).\n"
