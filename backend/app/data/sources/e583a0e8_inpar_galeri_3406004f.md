# View [inpar.galeri] not found. (500 Internal Server Error)

> Source: https://kd-sumedang.upi.edu/inpar/galeri

Symfony Exception
Source: inpar_galeri_3406004f.html
Symfony Exception
Symfony Docs
InvalidArgumentException
HTTP 500 Internal Server Error
View [inpar.galeri] not found.
...
view() in /usr/local/www/kdsumedang/routes/web.php (line 963)
Route::get('inpar/visimisi', function () {
    return view('inpar/visimisi');
});
Route::get('inpar/galeri', function () {
    return view('inpar/galeri');
});
Route::get('inpar/sejarah', function () {
    return view('inpar/sejarah');
});
in /usr/local/www/kdsumedang/vendor/laravel/framework/src/Illuminate/Routing/CallableDispatcher.php->{closure:/usr/local/www/kdsumedang/routes/web.php:962} (line 40)
