# View [inpar.grooming] not found. (500 Internal Server Error)

> Source: https://kd-sumedang.upi.edu/inpar/grooming

Symfony Exception
Source: inpar_grooming_acea71af.html
Symfony Exception
Symfony Docs
InvalidArgumentException
HTTP 500 Internal Server Error
View [inpar.grooming] not found.
...
view() in /usr/local/www/kdsumedang/routes/web.php (line 975)
...
Route::get('inpar/jurnal_inpar', function () {
    $jurnalinpar = JurnalInpar::get();
    return view('inpar/jurnal_inpar' , ['jurnalinpar' => $jurnalinpar]);
in /usr/local/www/kdsumedang/vendor/laravel/framework/src/Illuminate/Routing/CallableDispatcher.php->{closure:/usr/local/www/kdsumedang/routes/web.php:974} (line 40)
